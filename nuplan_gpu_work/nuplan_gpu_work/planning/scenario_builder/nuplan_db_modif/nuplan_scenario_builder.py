...
from nuplan_gpu_work.planning.scenario_builder.nuplan_db_modif.nuplan_scenario_filter_utils import (
    FilterWrapper,
...
from nuplan_gpu_work.planning.scenario_builder.nuplan_db_modif.nuplan_scenario_utils import ScenarioMapping, absolute_path_to_log_name
...
class NuPlanScenarioBuilder(AbstractScenarioBuilder):
    ...
    def get_scenario_type(cls) -> Type[AbstractScenario]:
        ...
        return cast(Type[AbstractScenario], NuPlanScenarioModif)
