...
from nuplan_gpu_work.planning.scenario_builder.nuplan_db_modif.nuplan_scenario_utils import (
...
ScenarioDict = Dict[str, List[NuPlanScenarioModif]]
...
def _filter_scenarios_by_timestamp(
    scenario_list: List[NuPlanScenarioModif], timestamp_threshold_s: float
) -> List[NuPlanScenarioModif]:
    """
    ...
    def _extract_initial_lidar_timestamp(scenario: NuPlanScenarioModif) -> int:
...
def _filter_scenarios(
    ...
    def _filter_scenarios_from_scenario_list(
        scenario_list: List[NuPlanScenarioModif], num_scenarios_to_keep: int, randomize: bool
    ) -> List[NuPlanScenarioModif]:
        """
...
def filter_invalid_goals(scenario_dict: ScenarioDict, worker: WorkerPool) -> ScenarioDict:
    ...
    def _filter_goals(scenarios: List[NuPlanScenarioModif]) -> List[NuPlanScenarioModif]:
        """
...
def filter_fraction_lidarpc_tokens_in_set(
    ...
    def _are_lidarpc_tokens_in_set(scenario: NuPlanScenarioModif, token_set: Set[str], fraction_threshold: float) -> bool:
        """
        ...
        :param scenario: a valid NuPlanScenarioModif instance.
...
def _is_non_stationary(scenario: NuPlanScenarioModif, minimum_threshold: float) -> bool:
    """
...
def _check_for_speed_edge(
    scenario: NuPlanScenarioModif, speed_threshold: float, speed_noise_tolerance: float, edge_type: EdgeType
) -> bool:
    """
...
def _ego_has_route(scenario: NuPlanScenarioModif, map_radius: float) -> bool:
    """
...
def scenario_dict_to_list(scenario_dict: ScenarioDict, shuffle: Optional[bool] = None) -> List[NuPlanScenarioModif]:
    """
...
def scenario_list_to_dict(scenario_list: List[NuPlanScenarioModif]) -> ScenarioDict:
    """
