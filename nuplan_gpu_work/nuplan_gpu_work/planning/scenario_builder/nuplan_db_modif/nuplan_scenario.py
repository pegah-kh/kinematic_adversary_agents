...
from nuplan_gpu_work.planning.scenario_builder.nuplan_db_modif.nuplan_scenario_utils import extract_tracked_objects, modified_extract_tracked_objects
...
class NuPlanScenarioModif(AbstractScenario):
    ...
    def __reduce__(self) -> Tuple[Type[NuPlanScenarioModif], Tuple[Any, ...]]:
        """
    ...
    # this is the function called from the observation
    def modified_get_tracked_objects_at_iteration(
        self,
        iteration: int,
        ...
        return DetectionsTracks(
            modified_extract_tracked_objects(self._lidarpc_tokens[iteration], self._log_file, changed_prediction, future_trajectory_sampling)
        )
