...
from nuplan_king.planning.simulation.adversary_optimizer.executor import run_optimization

from nuplan.common.utils.s3_utils import is_s3_path
from nuplan_king.planning.script.builders.adversary_builder import build_adversary
