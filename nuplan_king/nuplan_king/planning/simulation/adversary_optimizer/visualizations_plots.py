...
class Plots():
    ...
    def visualize_grads_throttle(self, optimization_iteration, number_agents, whole_state_buffers, throttle_gradients):
        ...
        create_directory_if_not_exists(f'{self._plot_path}/Throttle_Grad_Evolution')
        ...
        plt.gcf()
        plt.savefig(f'{self._plot_path}/Throttle_Grad_Evolution/{optimization_iteration}.png')
        plt.show()
        plt.clf()



    def visualize_grads_steer(self, optimization_iteration, number_agents, whole_state_buffers, steer_gradients):
        ...
        create_directory_if_not_exists(f'{self._plot_path}/Steer_Grad_Evolution')
        ...
        plt.gcf()
        plt.savefig(f'{self._plot_path}/Steer_Grad_Evolution/{optimization_iteration}.png')
        plt.show()
        plt.clf()
    ...
    def visualize_throttle(self, optimization_iteration, number_agents, whole_state_buffers, throttles):
        ...
        create_directory_if_not_exists(f'{self._plot_path}/Throttle_Evolution')
        ...
        plt.gcf()
        plt.savefig(f'{self._plot_path}/Throttle_Evolution/{optimization_iteration}.png')
        plt.show()
        plt.clf()



    def visualize_steer(self, optimization_iteration, number_agents, whole_state_buffers, steers):
        ...
        create_directory_if_not_exists(f'{self._plot_path}/Steer_Evolution')
        ...
        plt.gcf()
        plt.savefig(f'{self._plot_path}/Steer_Evolution/{optimization_iteration}.png')
        plt.show()
        plt.clf()


    def plot_loss_per_agent(self, number_agents, whole_state_buffers, drivable_loss_per_opt, collision_loss_per_opt):
        ...
        plt.gcf()
        plt.savefig(f'{self._plot_path}/drivable_loss_evolution_agents_per_opt.png')
        ...
        plt.gcf()
        plt.savefig(f'{self._plot_path}/collition_loss_evolution_agents_per_opt.png')
        plt.show()
        plt.clf()



    def plot_losses(self, costs_to_use, deviation_losses_per_opt, deviation_loss_per_step, collision_loss_per_opt, collision_loss_per_step):
        """
        ...
        if 'drivable_king' in costs_to_use or 'drivable_efficient' in costs_to_use:
            ...
            plt.gcf()
            plt.savefig(f'{self._plot_path}/deviation_losses_per_opt.png')
            ...
            plt.legend() 
            plt.gcf()
            plt.savefig(f'{self._plot_path}/deviation_loss_per_step.png')
        ...
        if 'fixed_dummy' in costs_to_use or 'moving_dummy' in costs_to_use or 'collision' in costs_to_use:
            ...
            plt.gcf()
            plt.savefig(f'{self._plot_path}/collision_loss_per_opt.png')
            ...
            plt.legend() 
            plt.gcf()
            plt.savefig(f'{self._plot_path}/collision_loss_per_step.png')
